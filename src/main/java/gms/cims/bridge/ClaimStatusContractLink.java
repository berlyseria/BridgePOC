...
public class ClaimStatusContractLink extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -8831968799907707111L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"ClaimStatusContractLink\",\"namespace\":\"gms.cims.bridge\",\"fields\":[{\"name\":\"CL_ClaimID\",\"type\":[\"int\",\"null\"],\"default\":-1},{\"name\":\"CS_ClaimStatusID\",\"type\":[\"int\",\"null\"],\"default\":-1},{\"name\":\"CS_Description\",\"type\":[\"string\",\"null\"],\"default\":\"NONE\"},{\"name\":\"CC_Relationship\",\"type\":[\"int\",\"null\"],\"default\":-1},{\"name\":\"CO_ContractID\",\"type\":[\"int\",\"null\"],\"default\":-1}]}");
  public static org.apache.avro.Schema getClassSchema() { return SCHEMA$; }

  private static SpecificData MODEL$ = new SpecificData();

  private static final BinaryMessageEncoder<ClaimStatusContractLink> ENCODER =
      new BinaryMessageEncoder<ClaimStatusContractLink>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<ClaimStatusContractLink> DECODER =
      new BinaryMessageDecoder<ClaimStatusContractLink>(MODEL$, SCHEMA$);

  /**
   * Return the BinaryMessageDecoder instance used by this class.
   */
  public static BinaryMessageDecoder<ClaimStatusContractLink> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<ClaimStatusContractLink> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<ClaimStatusContractLink>(MODEL$, SCHEMA$, resolver);
  }

  /** Serializes this ClaimStatusContractLink to a ByteBuffer. */
  public java.nio.ByteBuffer toByteBuffer() throws java.io.IOException {
    return ENCODER.encode(this);
  }

  /** Deserializes a ClaimStatusContractLink from a ByteBuffer. */
  public static ClaimStatusContractLink fromByteBuffer(
   ...
   */
  public ClaimStatusContractLink() {}
   ...
   */
  public ClaimStatusContractLink(java.lang.Integer CL_ClaimID, java.lang.Integer CS_ClaimStatusID, java.lang.CharSequence CS_Description, java.lang.Integer CC_Relationship, java.lang.Integer CO_ContractID) {
  ...
  /**
   * Creates a new ClaimStatusContractLink RecordBuilder.
   * @return A new ClaimStatusContractLink RecordBuilder
   */
  public static gms.cims.bridge.ClaimStatusContractLink.Builder newBuilder() {
    return new gms.cims.bridge.ClaimStatusContractLink.Builder();
  }

  /**
   * Creates a new ClaimStatusContractLink RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new ClaimStatusContractLink RecordBuilder
   */
  public static gms.cims.bridge.ClaimStatusContractLink.Builder newBuilder(gms.cims.bridge.ClaimStatusContractLink.Builder other) {
    return new gms.cims.bridge.ClaimStatusContractLink.Builder(other);
  }

  /**
   * Creates a new ClaimStatusContractLink RecordBuilder by copying an existing ClaimStatusContractLink instance.
   * @param other The existing instance to copy.
   * @return A new ClaimStatusContractLink RecordBuilder
   */
  public static gms.cims.bridge.ClaimStatusContractLink.Builder newBuilder(gms.cims.bridge.ClaimStatusContractLink other) {
    return new gms.cims.bridge.ClaimStatusContractLink.Builder(other);
  }

  /**
   * RecordBuilder for ClaimStatusContractLink instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ClaimStatusContractLink>
    implements org.apache.avro.data.RecordBuilder<ClaimStatusContractLink> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(gms.cims.bridge.ClaimStatusContractLink.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing ClaimStatusContractLink instance
     * @param other The existing instance to copy.
     */
    private Builder(gms.cims.bridge.ClaimStatusContractLink other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.CL_ClaimID)) {
        this.CL_ClaimID = data().deepCopy(fields()[0].schema(), other.CL_ClaimID);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public gms.cims.bridge.ClaimStatusContractLink.Builder setCLClaimID(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public gms.cims.bridge.ClaimStatusContractLink.Builder clearCLClaimID() {
      CL_ClaimID = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public gms.cims.bridge.ClaimStatusContractLink.Builder setCSClaimStatusID(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public gms.cims.bridge.ClaimStatusContractLink.Builder clearCSClaimStatusID() {
    ...
    /**
      ...
      * @return This builder.
      */
    public gms.cims.bridge.ClaimStatusContractLink.Builder setCSDescription(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public gms.cims.bridge.ClaimStatusContractLink.Builder clearCSDescription() {
      CS_Description = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public gms.cims.bridge.ClaimStatusContractLink.Builder setCCRelationship(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public gms.cims.bridge.ClaimStatusContractLink.Builder clearCCRelationship() {
    ...
    /**
      ...
      * @return This builder.
      */
    public gms.cims.bridge.ClaimStatusContractLink.Builder setCOContractID(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public gms.cims.bridge.ClaimStatusContractLink.Builder clearCOContractID() {
      CO_ContractID = null;
    ...
    public ClaimStatusContractLink build() {
      try {
        ClaimStatusContractLink record = new ClaimStatusContractLink();
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<ClaimStatusContractLink>
    WRITER$ = (org.apache.avro.io.DatumWriter<ClaimStatusContractLink>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<ClaimStatusContractLink>
    READER$ = (org.apache.avro.io.DatumReader<ClaimStatusContractLink>)MODEL$.createDatumReader(SCHEMA$);
